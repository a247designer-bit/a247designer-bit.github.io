...
// ("Static Mesh Gradient"). Zero dependencies: one WebGL canvas that fills its
// parent. Drop it behind your content with
// <div className="relative"><ShaderBackground className="absolute inset-0" />…
// Adapted from Paper Shaders: https://shaders.paper.design/static-mesh-gradient
...
const UNIFORMS = {
  colors: [[0.03137254901960784,0.10980392156862745,0.08235294117647059],[0.17647058823529413,0.41568627450980394,0.30980392156862746],[0.5843137254901961,0.8352941176470589,0.6980392156862745],[1,0.9529411764705882,0.6901960784313725],[1,0.9529411764705882,0.6901960784313725],[1,0.9529411764705882,0.6901960784313725],[1,0.9529411764705882,0.6901960784313725],[1,0.9529411764705882,0.6901960784313725]] as [number, number, number][],
  colorCount: 4,
  scale: 1.260,
  intensity: 0.350,
  paramA: 0.280,
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // Some browsers skip a ResizeObserver's guaranteed first callback when the
    // observed box hasn't changed since a prior (e.g. Strict Mode double-
    // invoked) observation, leaving the canvas at its 300x150 default until
    // something else resizes the window. Size it explicitly on mount too.
    updateLayout()
